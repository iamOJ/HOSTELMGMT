 ...
 * @author Ojaswi Kumar
 */
public class ChangePassowrdAdmin extends javax.swing.JFrame {

    /**
     * Creates new form ChangePassowrdAdmin
     */
    
    static String adminid="";
    public ChangePassowrdAdmin(String id) {
        initComponents();
        adminid=id;
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChangePassowrdAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ChangePassowrdAdmin(adminid).setVisible(true);
            }
        });
    }
